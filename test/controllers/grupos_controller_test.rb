...
class GruposControllerTest < ActionController::TestCase
  ...
  test "should create grupo" do
    assert_difference('Grupo.count') do
      post :create, grupo: { alumno_id: @grupo.alumno_id, asignatura_id: @grupo.asignatura_id, calificacion: @grupo.calificacion, grupo: @grupo.grupo, profesor_id: @grupo.profesor_id }
    end
  ...
  test "should update grupo" do
    patch :update, id: @grupo, grupo: { alumno_id: @grupo.alumno_id, asignatura_id: @grupo.asignatura_id, calificacion: @grupo.calificacion, grupo: @grupo.grupo, profesor_id: @grupo.profesor_id }
    assert_redirected_to grupo_path(assigns(:grupo))
  end
