class AsignaturasController < ApplicationController
  ...
  def index
    @asignaturas = Asignatura.all.order("nombre asc")
  end
  ...
  def create
    ...
    respond_to do |format|
      if @asignatura.save
        format.html { redirect_to @asignatura, notice: 'La asignatura ha sido creada.' }
  ...
  def update
    respond_to do |format|
      if @asignatura.update(asignatura_params)
        format.html { redirect_to @asignatura, notice: 'La asignatura fue actualizada correctamente.' }
  ...
  def destroy
    @asignatura.destroy
    respond_to do |format|
      format.html { redirect_to asignaturas_url, notice: 'La asignatura fue eliminada.' }
